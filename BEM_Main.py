...
Dis_method = 'cosine'   #Discretisation method, ('cosine' or 'constant')
...
if convergence_test:
    ...
    for N_ann in N_ann_list:
        ...
        results = np.zeros((N_ann,13))                                     #***CHANGE***
...
if convergence_test:
    fig_prandtl = plt.figure(figsize=(12,6))
    plt.title(r'Convergence of C_{t} and $C_{p}$')
    plt.grid()
    plt.yscale('log')
